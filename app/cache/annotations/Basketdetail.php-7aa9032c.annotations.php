...
return array(
  ...
  'models\\Basketdetail::$idBasket' => array(
    ...
    array('#name' => 'column', '#type' => 'Ubiquity\\annotations\\items\\ColumnAnnotation', "name"=>"idBasket","dbType"=>"int(11)"),
  ...
  'models\\Basketdetail::$quantity' => array(
    array('#name' => 'column', '#type' => 'Ubiquity\\annotations\\items\\ColumnAnnotation', "name"=>"quantity","dbType"=>"int(11)"),
